...
CREATE TABLE `lavanderia_blancos` (
  ...
  `hotel_id` int NOT NULL,
  `nombre` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL,
  `categoria` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'otro',
...
CREATE TABLE `lavanderia_lotes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hotel_id` int NOT NULL,
  `tipo` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'interno',
  `estado` enum('en_proceso','recibido','cancelado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en_proceso',
  `proveedor` varchar(160) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `lavanderia_pedidos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hotel_id` int NOT NULL,
  `cliente_nombre` varchar(160) COLLATE utf8mb4_unicode_ci NOT NULL,
  `reservacion_id` int DEFAULT NULL,
  `habitacion_etiqueta` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `estado` enum('recibido','en_proceso','listo','entregado','cancelado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'recibido',
...
CREATE TABLE `modulos` (
  ...
  `tipo_comercial` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'opcional',
  ...
  KEY `idx_modulos_tipo_comercial` (`tipo_comercial`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
