 ...
 *     sidebar: can(permiso) || rol del hotel en la lista. 'permiso' puede ser un
 *     string o una lista any-of (ej. Limpieza: ['camarista.view','tareas.view']).
 *     Si ambos son null, solo aplica el requisito de modulo.
 *
 * IMPORTANTE (roles personalizados): un rol personalizado guarda el ENUM legacy
 * 'recepcionista' (ver UsuarioController::resolverAsignacionRol), asi que el
 * gate por 'roles' NO distingue roles custom. Para acotar de verdad (que un
 * camarista solo vea lo suyo) las pantallas operativas se gatean por 'permiso'
 * con 'roles' => null; 'roles' se reserva a extras de gerencia sin permiso propio.
 *
...
return [
    ...
    ['ruta' => 'operacion/diaria',      'etiqueta' => 'El hotel hoy',        'icono' => 'fa-clipboard-check',     'modulo' => 'tablero_ejecutivo','permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'operacion diaria tablero ejecutivo pendientes hoy resumen'],
    ['ruta' => 'forecast',              'etiqueta' => 'Pronóstico de ocupación', 'icono' => 'fa-arrow-trend-up',  'modulo' => 'forecast',         'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'forecast pronostico proyeccion ocupacion temporadas eventos'],
    ...
    ['ruta' => 'checkin-digital',       'etiqueta' => 'Check-in digital',    'icono' => 'fa-qrcode',              'modulo' => 'checkin_digital',  'permiso' => 'reservaciones.view', 'roles' => null, 'buscar' => 'pre-registro links qr codigo digital'],
    ...
    ['ruta' => 'cuentas-por-cobrar',    'etiqueta' => 'Cuentas por cobrar',  'icono' => 'fa-hand-holding-dollar', 'modulo' => 'cuentas_cobrar',   'permiso' => 'cuentas_por_cobrar.view', 'roles' => null, 'buscar' => 'cxc deudas creditos'],
    ...
    ['ruta' => 'tareas',                'etiqueta' => 'Tareas',              'icono' => 'fa-tasks',               'modulo' => 'tareas',           'permiso' => 'tareas.view', 'roles' => null, 'buscar' => 'pendientes operativas'],
    ['ruta' => 'mantenimientos/activos','etiqueta' => 'Mantenimiento',       'icono' => 'fa-toolbox',             'modulo' => 'mantenimiento_plus','permiso' => ['tareas.view', 'habitaciones.mantenimiento'], 'roles' => null, 'buscar' => 'activos preventivo boiler servicio incidencias evidencia'],
    ...
    ['ruta' => 'motor-reservas',        'etiqueta' => 'Reservas en línea',   'icono' => 'fa-globe',               'modulo' => 'motor_reservas',   'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'motor de reservas online booking web pagina publica'],
    ['ruta' => 'canales',               'etiqueta' => 'Airbnb y Booking',    'icono' => 'fa-calendar-alt',        'modulo' => 'canales_ical',     'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'canales ical ota booking airbnb sincronizacion calendarios'],
    ['ruta' => 'whatsapp',              'etiqueta' => 'Conectar WhatsApp',   'icono' => 'fab fa-whatsapp',        'modulo' => 'whatsapp',         'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'whatsapp numero conexion mensajes confirmaciones'],
    ['ruta' => 'mensajes',              'etiqueta' => 'Mensajes a huéspedes','icono' => 'fa-comment-dots',        'modulo' => 'canal_whatsapp',   'permiso' => 'reservaciones.view', 'roles' => null, 'buscar' => 'whatsapp cola confirmaciones recordatorios encuestas anticipo huesped'],
    ...
    ['ruta' => 'copiloto/valor',        'etiqueta' => 'Uso del asistente',   'icono' => 'fa-robot',               'modulo' => 'copiloto',         'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'copiloto asistente ia uso valor numeros'],
    ['ruta' => 'reputacion',            'etiqueta' => 'Opiniones y encuestas', 'icono' => 'fa-star',              'modulo' => 'reputacion',       'permiso' => 'reputacion.view', 'roles' => ['gerente', 'administrador'], 'buscar' => 'reputacion reseñas encuestas nps satisfaccion opiniones'],
    ['ruta' => 'lealtad',               'etiqueta' => 'Huésped frecuente',   'icono' => 'fa-heart',               'modulo' => 'lealtad',          'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'lealtad puntos recompensas frecuente regresa'],
    ['ruta' => 'night-audit',           'etiqueta' => 'Cierre del día',      'icono' => 'fa-moon',                'modulo' => 'night_audit',      'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'night audit cierre nocturno no-show noshow checkouts vencidos cortes'],
    ['ruta' => 'reportes',              'etiqueta' => 'Reportes',            'icono' => 'fa-chart-line',          'modulo' => 'reportes',         'permiso' => 'reportes.view', 'roles' => null, 'buscar' => 'estadisticas graficas exportar'],
    ...
    ['ruta' => 'configuracion/tarifas', 'etiqueta' => 'Precios y temporadas','icono' => 'fa-tags',                'modulo' => ['tarifas_dinamicas', 'tarifas'], 'permiso' => 'tarifas.view', 'roles' => ['gerente', 'administrador'], 'buscar' => 'tarifas dinamicas precios temporadas incrementos'],
    ...
    ['ruta' => 'auditoria',             'etiqueta' => 'Historial de actividad', 'icono' => 'fa-clock-rotate-left','modulo' => 'auditoria',        'permiso' => null, 'roles' => ['gerente', 'administrador'], 'buscar' => 'bitacora auditoria historial actividad quien hizo cambios'],
];
