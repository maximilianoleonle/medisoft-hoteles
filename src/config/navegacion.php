...
return [
    ...
    // Personal = registro de gente + tareas. La nomina se busca por 'nomina' y cae
    // en el modulo Nomina (abajo), no aqui: ver personal_nomina_legacy_visible().
    ['ruta' => 'trabajadores',          'etiqueta' => 'Personal',            'icono' => 'fa-id-card',             'modulo' => 'personal',         'permiso' => 'personal.view', 'roles' => null, 'buscar' => 'empleados trabajadores equipo plantilla altas bajas tareas'],
    ['ruta' => 'trabajadores/informes', 'etiqueta' => 'Personal · Informes', 'icono' => 'fa-chart-pie',           'modulo' => 'personal',         'permiso' => 'personal.view', 'roles' => null, 'buscar' => 'reportes informes equipo roles altas bajas composicion'],
