...
class CopilotoService
{
    ...
    private function ayudaConocimiento(int $hotelId): string
    {
        ...
        $opcionales = [
            ...
            'motor_reservas' => "- Reservas en linea con pago de anticipo: seccion Reservas en linea.",
            'promociones' => "- Cupones de descuento del motor: Reservas en linea > Cupones.",
            'upsells' => "- Extras del motor (desayuno, late checkout): Reservas en linea > Extras.",
            'reputacion' => "- Encuestas y resenas: seccion Opiniones y encuestas.",
            'lealtad' => "- Huespedes frecuentes y su cupon: seccion Huesped frecuente.",
            'forecast' => "- Proyeccion de ocupacion 30/60/90 dias: seccion Pronostico de ocupacion.",
            'night_audit' => "- Cierre nocturno (no-shows, checkouts vencidos): seccion Cierre del dia.",
            'auditoria' => "- Registro de quien hizo que: seccion Historial de actividad (solo gerencia).",
            ...
            'camarista' => "- Tablero movil de limpieza: seccion Limpieza.",
            'canales_ical' => "- Sincronizacion de calendarios Airbnb/Booking: seccion Airbnb y Booking.",
            'whatsapp' => "- Mensajes automaticos de WhatsApp: seccion Conectar WhatsApp.",
            'tablero_ejecutivo' => "- Tablero de direccion y conciliacion financiera: seccion El hotel hoy.",
