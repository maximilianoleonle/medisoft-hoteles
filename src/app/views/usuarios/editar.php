...
$usuarioRolValor = (string) old('rol', $usuarioRol);
                                ...
                                <div class="worker-field is-full">
                                    ...
                                    <div class="worker-control-wrap">
                                        ...
                                        <input type="text"
                                               ...
                                               class="worker-input<?= usuario_form_error_class($usuarioFieldErrors, 'nombre_usuario') ?>"<?= usuario_form_error_attrs($usuarioFieldErrors, 'nombre_usuario', 'ms-form-error-usuario_nombre_usuario') ?>>
                                    </div>
                                ...
                                <div class="worker-field">
                                    ...
                                    <div class="worker-control-wrap">
                                        ...
                                        <input type="password"
                                               ...
                                               placeholder="Dejar vacio para mantener"<?= usuario_form_error_attrs($usuarioFieldErrors, 'password', 'ms-form-error-usuario_password') ?>>
                                ...
                                <div class="worker-field">
                                    ...
                                    <?php else: ?>
                                        <div class="worker-control-wrap">
                                            ...
                                            <?php $roleIdSel = (string) old('role_id', (string) ($usuarioRoleId ?? '')); ?>
                                ...
                                <div class="worker-field is-full">
                                    ...
                                    <div class="worker-control-wrap">
                                        ...
                                        <input type="text"
                                               ...
                                               required
                                               class="worker-input<?= usuario_form_error_class($usuarioFieldErrors, 'nombre_completo') ?>"<?= usuario_form_error_attrs($usuarioFieldErrors, 'nombre_completo', 'ms-form-error-usuario_nombre_completo') ?>>
                                    </div>
                    ...
                    <section class="worker-panel worker-preview-card">
                        ...
                        <div class="worker-preview-list">
                            <div class="worker-preview-row">
                                <span>Rol</span>
                                <strong id="preview-rol"><?= htmlspecialchars(ucfirst($usuarioRolValor), ENT_QUOTES, 'UTF-8') ?></strong>
                            </div>
                            <div class="worker-preview-row">
                                <span>Email</span>
...
<script>
const rolInicial = <?= json_encode($usuarioRolValor, JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP) ?>;
