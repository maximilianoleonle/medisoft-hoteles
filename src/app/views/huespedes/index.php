...
.guests-page .guest-hero-icon { width: 48px !important; height: 48px !important; border-radius: 15px !important; background: radial-gradient(circle at 30% 24%, rgba(255,255,255,.24), transparent 34%), linear-gradient(145deg, var(--guest-gold), var(--guest-brand) 54%, color-mix(in srgb, var(--guest-brand) 68%, var(--brand-accent, #BD9441))) !important; color: #fff !important; border: none !important; box-shadow: 0 14px 26px -14px color-mix(in srgb, var(--guest-brand) 72%, transparent) !important; }
