    ...
    <section class="p-6">
        ...
        <?php else: ?>
            <div class="worker-panel p-4 mb-4">
                <form method="GET" action="<?= url('trabajadores') ?>" class="grid grid-cols-1 md:grid-cols-[1fr_180px_auto_auto_auto_auto_auto] gap-3">
                    ...
                    <a class="worker-btn" href="<?= url('trabajadores/pagos-caja/reporte') ?>">
