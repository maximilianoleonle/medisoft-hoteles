<?php /* Skeleton propio: Cuentas por cobrar (hero + filtros + resumen + tabla). */ ?>
<div class="psk-wrap">
    <div class="psk-hd">
        ...
        <div class="psk-hd-lines">
            ...
            <div class="psk-bone" style="height:22px;width:44%"></div>
    ...
    <div class="psk-rows">
        <?php $w = [58,66,50,62,54,60,48]; for ($i = 0; $i < 7; $i++): ?>
        <div class="psk-row">
