...
.tk-page.tk-page--board {
    ...
    --tk-view-soft: color-mix(in srgb, var(--tk-gold) 10%, #FFFFFF);
}
.tk-page.tk-page--board .tk-title-lockup {
    padding: 2px 0 10px;
    border-bottom: 1px solid color-mix(in srgb, var(--tk-gold) 22%, transparent);
}
...
.tk-page .tk-view-chip { display: inline-flex; align-items: center; gap: 7px; width: fit-content; margin-top: 10px; padding: 6px 10px; border-radius: 999px; background: var(--tk-view-soft); border: 1px solid color-mix(in srgb, var(--tk-view-accent) 30%, #fff); color: color-mix(in srgb, var(--tk-view-accent) 76%, #000); font-size: .72rem; font-weight: 700; line-height: 1; }
...
.tk-page.tk-page--board .tk-summary-item::before { content: ""; position: absolute; inset: 0 auto 0 0; width: 4px; background: linear-gradient(180deg, var(--tk-view-accent), color-mix(in srgb, var(--tk-brand) 74%, var(--tk-view-accent))); }
...
.tk-page .tk-field-label { color: var(--tk-muted); font-size: .68rem; font-weight: 700; letter-spacing: .045em; line-height: 1; text-transform: uppercase; }
...
.tk-page .tk-filter-note { display: flex; align-items: center; justify-content: space-between; gap: 12px; margin-top: 12px; padding: 10px 12px; border: 1px solid var(--tk-gold-line); border-radius: 12px; background: var(--tk-gold-soft); color: var(--tk-gold-ink); font-size: .82rem; font-weight: 700; line-height: 1.35; }
...
.tk-page .tk-inline-action { display: inline-flex; align-items: center; gap: 5px; margin-left: 8px; color: var(--tk-gold-ink); text-decoration: none; font-size: .72rem; font-weight: 700; }
.tk-page .tk-inline-action:hover { text-decoration: underline; text-underline-offset: 3px; }
.tk-page .tk-assigned-list { display: inline-block; color: var(--tk-heading); font-weight: 700; line-height: 1.3; }
