...
.lim-rep{
    ...
    color:var(--lr-ink);
    background:
        repeating-linear-gradient(135deg, rgba(40,118,111,.045) 0 1px, transparent 1px 22px),
        linear-gradient(180deg,#fffefd,var(--lr-soft));
}
...
.lim-rep-btn:hover{border-color:color-mix(in srgb,var(--lr-clean) 42%,var(--lr-line));background:#f5fffb}
...
.lim-rep-table th{padding:13px 16px;border-bottom:1px solid var(--lr-line);background:#fbfdfa;color:var(--lr-muted);font-size:.72rem;font-weight:950;letter-spacing:.075em;text-align:left;text-transform:uppercase}
.lim-rep-table td{padding:16px;border-bottom:1px solid #e9f0ed;vertical-align:top;color:var(--lr-ink);font-size:.92rem}
.lim-rep-table tbody tr:hover{background:#f5fffb}
...
.lim-rep-note{padding:14px 18px;border-top:1px solid var(--lr-line);background:#fbfdfa;color:#5f6b7a;font-size:.8rem;font-weight:750;line-height:1.38}
...
@media (max-width:720px){
    ...
    .lim-rep-table-wrap{overflow:visible;padding:0;background:#f3f8f5}
    .lim-rep-table{display:none!important}
    .lim-rep-mobile-list{display:grid;gap:10px;padding:10px;background:#f3f8f5}
    ...
    .lim-rep-room-cell{min-width:0;padding:8px 9px;border:1px solid #e1ece8;border-radius:12px;background:#fbfdfa}
    ...
    .lim-rep-room-review{display:grid;gap:8px;min-width:0;padding:10px 12px 12px 15px;border-top:1px solid #e9f0ed;background:#f5fffb}
