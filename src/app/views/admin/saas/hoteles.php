...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="hidden bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden md:block">
        <div class="border-b px-5 py-4" style="border-color:var(--ms-border);">
            ...
            <p class="mt-1 text-sm text-gray-600">Listado operativo para soporte, ventas y administracion SaaS.</p>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="px-5 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Codigo</th>
            ...
            <?php foreach ($hoteles as $hotel): ?>
                ...
                <article class="rounded-lg border bg-white p-4 shadow-sm" style="border-color:var(--ms-border);">
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                        <div>
                            <div class="text-xs font-semibold uppercase tracking-wider text-gray-500">Codigo</div>
