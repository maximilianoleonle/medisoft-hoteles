# Expediente comercial integral — Medisoft Hoteles

Fecha de corte: 26 de julio de 2026  
Mercado inicial: Santa Catarina Juquila, Oaxaca  
Objetivo: obtener la primera venta nueva mediante contratación directa o piloto guiado de 30 días.

## Cómo leer este expediente

Cada afirmación relevante se clasifica como:

- **DV — Dato verificado:** fuente externa identificada y fecha de consulta.
- **HS — Hallazgo del sistema:** comprobado en código, interfaz o documentación técnica.
- **T — Testimonio:** declaración del equipo o cliente identificado.
- **I — Inferencia:** conclusión razonada; no debe presentarse como hecho.
- **H — Hipótesis:** debe probarse en campo.
- **P — Provisional:** decisión utilizable mientras se obtiene información faltante.

## Entregables

### Primero lee estos tres
...
4. [Auditoría comercial de todos los módulos](../auditoria_comercial_modulos_20260725.md).
5. [Análisis interno de Medisoft](../analisis_interno_comercial_medisoft_20260726.md).
...
Los datos externos describen el contexto, no reemplazan una conversación con el hotel. Los guiones no se recitan: se adaptan al problema comprobado. Ninguna cifra de ahorro, aumento de ingresos o reducción de errores se promete sin una medición real.
